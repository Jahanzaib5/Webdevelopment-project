...
if(($_POST['name'])== '' || ($_POST['email'])=='' || empty($_Post['subject'])=='')
	...
	if (!mysqli_select_db($con, $db)){
	   ...
	   $sql = "CREATE TABLE job(Name varchar(255), Email varchar(255), Subject varchar(255), Comment varchar(255))";
	   // Execute query
	   mysqli_query($con, $sql);
	}
	else{
	   mysqli_select_db($con, $db);
	   $sql="INSERT INTO job(Name, Email, Subject, Comment) VALUES('$name', '$email', '$subject', '$comment')";
